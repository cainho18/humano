...
export const Perspective = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn("[perspective:1200px] hw-perspective-in", className)}
      {...props}
    >
...
type HighlightColor = "rosa" | "amarelo";
...
export const Highlight = ({
  ...
  return (
    <span
      className={cn(
        "inline-block rounded-[3px] px-1 text-preto will-change-[transform,box-shadow]",
        className
      )}
      style={{
        background: BG[color],
        ...
        boxShadow: `rgba(${RING[color]}, calc(0.8 * var(--lift, 0))) 2px 1.5px 0px 0.75px, rgba(${RING[color]}, calc(0.3 * var(--lift, 0))) 8px 4px 4px 0px`,
        ...style,
      }}
      {...props}
    >
